// app/(main)/exams/village-field-assistant/VfaCountdown.tsx
'use client';

import React, { useState, useEffect } from 'react';
import { Box, Stack, Typography, Paper } from '@mui/material';

interface VfaCountdownProps {
  targetDate: string;
}

export default function VfaCountdown({ targetDate }: VfaCountdownProps) {
