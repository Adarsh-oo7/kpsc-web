// app/(main)/exams/ldc-lgs-august-2026/HubCountdown.tsx
'use client';

import React, { useState, useEffect } from 'react';
import { Box, Stack, Typography, Paper } from '@mui/material';

interface HubCountdownProps {
  targetDate: string;
}

export default function HubCountdown({ targetDate }: HubCountdownProps) {
    ...
    <Box sx={{ mt: 3, p: 2.5, borderRadius: '16px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', maxWidth: 450 }}>
      ...
      <Stack direction="row" spacing={2} sx={{ mt: 1.5 }}>
        {[
          ...
          >
            <Typography variant="h5" sx={{ fontWeight: 900, fontFamily: "'JetBrains Mono', monospace", color: '#8B5CF6' }}>
